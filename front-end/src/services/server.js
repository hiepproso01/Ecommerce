...
app.post('/payment', async (req, res) => {
  const { amount } = req.body; // Lấy amount từ request
  const embed_data = {
    
    //sau khi hoàn tất thanh toán sẽ đi vào link này (thường là link web thanh toán thành công của mình)
    redirecturl: 'http://localhost:5173/homepage',
  };
  ...
  const order = {
    ...
    description: `Entity Shop - Thanh toán hóa đơn #${transID}`,
    bank_code: '',
  };
...
app.listen(3000, function () {
  console.log('Zalopay is listening at port :3000');
});
